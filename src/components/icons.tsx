...
export const DHelp = () => (<D><circle cx="12" cy="12" r="9" /><path d="M9.6 9.4a2.5 2.5 0 1 1 3.4 2.3c-.9.5-1.4 1-1.4 2.1" /><path d="M12 17.4h.01" /></D>)
export const DChevRight = () => (<D><path d="M9 6l6 6-6 6" /></D>)
export const DChevLeft = () => (<D><path d="M15 6l-6 6 6 6" /></D>)
